...
**Source:** http://platform.claude.com/docs/en/manage-claude/compliance-api-access
...
Read organization-wide activity events with any key that has `read:compliance_activities`.](/docs/en/manage-claude/compliance-activity-feed)[Retrieve and delete chats, files, and projects

Use a Compliance Access Key with `read:compliance_user_data` to retrieve claude.ai content, and `delete:compliance_user_data` to delete it.](/docs/en/manage-claude/compliance-content-data)
