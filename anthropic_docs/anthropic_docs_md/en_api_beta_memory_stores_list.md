...
**Source:** http://platform.claude.com/docs/en/api/beta/memory_stores/list
...
data: optional array of [BetaManagedAgentsMemoryStore](/docs/en/api/beta#beta_managed_agents_memory_store) { id, created\_at, name, 5 more }
