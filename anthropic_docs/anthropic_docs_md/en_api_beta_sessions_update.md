...
**Source:** http://platform.claude.com/docs/en/api/beta/sessions/update
...
agent: optional [BetaManagedAgentsSessionAgentUpdate](/docs/en/api/beta#beta_managed_agents_session_agent_update) { mcp\_servers, tools }
