...
[Roles and Permissions](https://support.claude.com/en/articles/9267276-roles-and-permissions)[Project visibility and sharing](https://support.claude.com/en/articles/9519189-project-visibility-and-sharing)[Important Considerations Before Enabling Single Sign-On (SSO) and JIT/SCIM Provisioning](https://support.claude.com/en/articles/10276682-important-considerations-before-enabling-single-sign-on-sso-and-jit-scim-provisioning)[What happens to a user's data when they are removed from a Team or Enterprise organization?](https://support.claude.com/en/articles/12053672-what-happens-to-a-user-s-data-when-they-are-removed-from-a-team-or-enterprise-organization)[Usage Analytics for Enterprise Plans](https://support.claude.com/en/articles/12883420-usage-analytics-for-enterprise-plans)
