...
Get inspired by a curated selection of prompts for various tasks and use cases.](/docs/en/build-with-claude/prompt-engineering/be-clear-and-direct)[Prompt library
