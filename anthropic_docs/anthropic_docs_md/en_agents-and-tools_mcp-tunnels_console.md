...
**Source:** http://platform.claude.com/docs/en/agents-and-tools/mcp-tunnels/console
...
Run the stack on a single host. Both programmatic-access and manual flows.](/docs/en/agents-and-tools/mcp-tunnels/deploy-compose)[Deploy with Helm

Run the stack on a Kubernetes cluster. Both programmatic-access and manual flows.](/docs/en/agents-and-tools/mcp-tunnels/deploy-helm)
...
Install on a Kubernetes cluster using the Anthropic Helm chart.](/docs/en/agents-and-tools/mcp-tunnels/deploy-helm)[Security

Hardening guidance, credential rotation, and breach response.](/docs/en/agents-and-tools/mcp-tunnels/security)
