...
**Source:** http://platform.claude.com/docs/en/api/overview
...
Complete API specification for direct model interactions](/docs/en/api/messages/create)[Claude Managed Agents reference

Agents, Sessions, and Environments endpoints](/docs/en/managed-agents/sessions)[Client SDKs

Python, TypeScript, Java, Go, C#, Ruby, and PHP](/docs/en/api/client-sdks)[Rate limits

Usage tiers, spend limits, and token bucket algorithm](/docs/en/api/rate-limits)
