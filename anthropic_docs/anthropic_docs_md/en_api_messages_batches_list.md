...
**Source:** http://platform.claude.com/docs/en/api/messages/batches/list
...
data: array of [MessageBatch](/docs/en/api/messages#message_batch) { id, archived\_at, cancel\_initiated\_at, 7 more }
