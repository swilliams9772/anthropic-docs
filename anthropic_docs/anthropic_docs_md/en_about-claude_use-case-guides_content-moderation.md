...
**Source:** http://platform.claude.com/docs/en/about-claude/use-case-guides/content-moderation
...
Explore the guardrails guide for techniques to moderate interactions with Claude.](/docs/en/test-and-evaluate/strengthen-guardrails/reduce-hallucinations)
