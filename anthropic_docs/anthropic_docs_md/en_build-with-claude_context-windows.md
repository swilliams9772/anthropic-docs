...
See our model comparison table for a list of context window sizes and input / output token pricing by model.](/docs/en/about-claude/models/overview#latest-models-comparison)[Extended thinking overview
