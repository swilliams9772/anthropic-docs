...
Learn about the prompt generator in the Claude Console and try your hand at getting Claude to generate a prompt for you.](/docs/en/build-with-claude/prompt-engineering/prompt-generator)[Apply XML tags

If you want to level up your prompt variable game, wrap them in XML tags.](/docs/en/build-with-claude/prompt-engineering/use-xml-tags)[Claude Console
