...
**Source:** http://platform.claude.com/docs/en/build-with-claude/skills-guide
...
Create your first Skill](/docs/en/agents-and-tools/agent-skills/quickstart)[Create custom Skills

Best practices for authoring Skills](/docs/en/agents-and-tools/agent-skills/best-practices)
...
Complete API reference with all endpoints](/docs/en/api/skills/create-skill)[Authoring Guide

Best practices for writing effective Skills](/docs/en/agents-and-tools/agent-skills/best-practices)[Code Execution Tool

Learn about the code execution environment](/docs/en/agents-and-tools/tool-use/code-execution-tool)
