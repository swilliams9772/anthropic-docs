...
**Source:** http://platform.claude.com/docs/en/api/beta/sessions/resources/list
...
data: array of [BetaManagedAgentsSessionResource](/docs/en/api/beta#beta_managed_agents_session_resource)
