...
**Source:** http://platform.claude.com/docs/en/agents-and-tools/agent-skills/claude-api-skill
...
Learn about how Agent Skills work and the progressive disclosure model](/docs/en/agents-and-tools/agent-skills/overview)[Client SDKs

Browse the official Anthropic SDKs for all supported languages](/docs/en/api/client-sdks)[Skills repository
