# Tutorial: Build a tool

**Source:** http://platform.claude.com/docs/en/agents-and-tools/tool-use/build-a-tool-using-agent
...
Schema specification and best practices.](/docs/en/agents-and-tools/tool-use/define-tools)[Tool Runner deep dive

The full SDK abstraction reference.](/docs/en/agents-and-tools/tool-use/tool-runner)[Troubleshooting

Fix common tool-use errors.](/docs/en/agents-and-tools/tool-use/troubleshooting-tool-use)
