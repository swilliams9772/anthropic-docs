...
**Source:** http://platform.claude.com/docs/en/agents-and-tools/tool-use/tool-use-with-prompt-caching
...
Learn the full prompt caching model, including TTLs and pricing.](/docs/en/build-with-claude/prompt-caching)[Tool search

Load tools on demand without breaking your cache.](/docs/en/agents-and-tools/tool-use/tool-search-tool)[Tool reference

Browse all available tools and their parameters.](/docs/en/agents-and-tools/tool-use/tool-reference)
