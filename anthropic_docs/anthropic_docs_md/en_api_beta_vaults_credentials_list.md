...
**Source:** http://platform.claude.com/docs/en/api/beta/vaults/credentials/list
...
data: optional array of [BetaManagedAgentsCredential](/docs/en/api/beta#beta_managed_agents_credential) { id, archived\_at, auth, 6 more }
