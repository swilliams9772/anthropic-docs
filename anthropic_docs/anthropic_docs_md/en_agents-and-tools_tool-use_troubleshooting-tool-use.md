...
**Source:** http://platform.claude.com/docs/en/agents-and-tools/tool-use/troubleshooting-tool-use
...
Write schemas and descriptions that steer Claude toward the right tool.](/docs/en/agents-and-tools/tool-use/define-tools)[Handle tool calls
