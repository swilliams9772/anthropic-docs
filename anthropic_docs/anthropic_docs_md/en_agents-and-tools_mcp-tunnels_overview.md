...
**Source:** http://platform.claude.com/docs/en/agents-and-tools/mcp-tunnels/overview
...
The shortest path to a working tunnel: Docker Compose with a sample MCP server.](/docs/en/agents-and-tools/mcp-tunnels/quickstart)[Deploy with Helm

Install on a Kubernetes cluster using the Anthropic Helm chart.](/docs/en/agents-and-tools/mcp-tunnels/deploy-helm)[Deploy with Docker Compose

Install on a VM using Docker Compose.](/docs/en/agents-and-tools/mcp-tunnels/deploy-compose)
...
Diagnose connectivity, TLS, and routing issues.](/docs/en/agents-and-tools/mcp-tunnels/troubleshooting)[Reference

Proxy config fields, the Tunnels API, certificate requirements, and the setup CLI.](/docs/en/agents-and-tools/mcp-tunnels/reference)[MCP connector

Use tunneled servers from the Messages API.](/docs/en/agents-and-tools/mcp-connector)
