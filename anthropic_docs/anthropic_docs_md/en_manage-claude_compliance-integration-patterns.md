...
**Source:** http://platform.claude.com/docs/en/manage-claude/compliance-integration-patterns
...
Filter parameters, pagination, and the `Activity` object schema.](/docs/en/manage-claude/compliance-activity-feed)[Retrieve and delete chats, files, and projects

The content and hard-delete endpoints.](/docs/en/manage-claude/compliance-content-data)
