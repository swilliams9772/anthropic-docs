...
**Source:** http://platform.claude.com/docs/en/manage-claude/compliance-org-data
...
The full request and response schema for every organization, user, role, and group endpoint.](/docs/en/api/compliance/organizations)[Handle Compliance API errors

Verbatim error payloads and the fix for each.](/docs/en/manage-claude/compliance-errors)
