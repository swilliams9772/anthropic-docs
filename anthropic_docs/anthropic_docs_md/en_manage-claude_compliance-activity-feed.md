...
**Source:** http://platform.claude.com/docs/en/manage-claude/compliance-activity-feed
...
The full request and response schema for `GET /v1/compliance/activities`, including every supported `activity_types[]` value.](/docs/en/api/compliance/activities/list)[Retrieve and delete chats, files, and projects

Query and delete the underlying content for activities you find in the feed (Compliance Access Key required).](/docs/en/manage-claude/compliance-content-data)[Design your compliance integration

Choose a polling or batch consumption pattern and plan SIEM correlation.](/docs/en/manage-claude/compliance-integration-patterns)[Handle Compliance API errors

The full error catalog.](/docs/en/manage-claude/compliance-errors)
