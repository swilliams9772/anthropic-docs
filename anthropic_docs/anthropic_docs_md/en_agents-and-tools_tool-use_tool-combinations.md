...
**Source:** http://platform.claude.com/docs/en/agents-and-tools/tool-use/tool-combinations
...
Full catalog of Anthropic-provided tools with type strings and parameters.](/docs/en/agents-and-tools/tool-use/tool-reference)[Tool use overview

How tool use works and when to use Anthropic tools versus defining your own.](/docs/en/agents-and-tools/tool-use/overview)
