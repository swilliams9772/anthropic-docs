...
**Source:** http://platform.claude.com/docs/en/api/beta/messages/batches/list
...
data: array of [BetaMessageBatch](/docs/en/api/beta#beta_message_batch) { id, archived\_at, cancel\_initiated\_at, 7 more }
