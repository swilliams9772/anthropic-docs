# How can I uninstall the Claude app for iOS?

**Source:** https://support.claude.com/en/articles/9266493-how-can-i-uninstall-the-claude-app-for-ios

To uninstall the Claude app from your iOS device, hold down on the app from your home screen until you see the menu options. Click on “Remove App.” From the next series of options, select “Delete App.”

Note that if you have an active Claude Pro subscription and would like to uninstall the app, your subscription will not be automatically canceled. To cancel your subscription, follow the cancellation instructions [here](https://support.anthropic.com/en/articles/8325617-how-do-i-cancel-my-claude-pro-subscription).
