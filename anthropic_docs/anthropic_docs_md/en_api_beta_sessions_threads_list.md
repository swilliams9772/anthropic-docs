...
**Source:** http://platform.claude.com/docs/en/api/beta/sessions/threads/list
...
data: optional array of [BetaManagedAgentsSessionThread](/docs/en/api/beta#beta_managed_agents_session_thread) { id, agent, archived\_at, 8 more }
