...
**Source:** http://platform.claude.com/docs/en/api/beta/sessions/list
...
data: optional array of [BetaManagedAgentsSession](/docs/en/api/beta#beta_managed_agents_session) { id, agent, archived\_at, 12 more }
