...
**Source:** http://platform.claude.com/docs/en/api/beta/memory_stores/memories/list
...
data: optional array of [BetaManagedAgentsMemoryListItem](/docs/en/api/beta#beta_managed_agents_memory_list_item)
