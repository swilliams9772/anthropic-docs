...
**Source:** http://platform.claude.com/docs/en/agents-and-tools/tool-use/how-tool-use-works
...
Build an agent step by step from a single tool call to production.](/docs/en/agents-and-tools/tool-use/build-a-tool-using-agent)[Define tools

Schema specification, descriptions, and tool\_choice.](/docs/en/agents-and-tools/tool-use/define-tools)[Tool reference

Directory of Anthropic-provided tools.](/docs/en/agents-and-tools/tool-use/tool-reference)
