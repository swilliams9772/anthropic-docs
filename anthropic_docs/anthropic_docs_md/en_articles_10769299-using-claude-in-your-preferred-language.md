...
**Source:** https://support.claude.com/en/articles/10769299-using-claude-in-your-preferred-language

Claude is available in beta in multiple languages on web and desktop applications.
