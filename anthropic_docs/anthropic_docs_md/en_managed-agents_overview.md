...
**Source:** http://platform.claude.com/docs/en/managed-agents/overview
...
Create your first agent session](/docs/en/managed-agents/quickstart)[API reference

Full endpoint documentation](/docs/en/managed-agents/sessions)
