...
**Source:** http://platform.claude.com/docs/en/build-with-claude/compaction
...
Learn about context window sizes and management strategies.](/docs/en/build-with-claude/context-windows)[Context editing

Explore other strategies for managing conversation context like tool result clearing and thinking block clearing.](/docs/en/build-with-claude/context-editing)
