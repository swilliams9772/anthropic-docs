...
Create your first Skill](/docs/en/agents-and-tools/agent-skills/quickstart)[API Guide

Use Skills with the Claude API](/docs/en/build-with-claude/skills-guide)[Use Skills in Claude Code

Create and manage custom Skills in Claude Code](https://code.claude.com/docs/en/skills)[Use Skills in the Agent SDK

Use Skills programmatically in TypeScript and Python](/docs/en/agent-sdk/skills)[Authoring best practices

Write Skills that Claude can use effectively](/docs/en/agents-and-tools/agent-skills/best-practices)
