...
**Source:** https://platform.claude.com/docs/en/about-claude/models/extended-thinking-models
...
In rare cases where you need access to full thinking output for Claude 4 models, [contact our sales team](/cdn-cgi/l/email-protection#88fbe9e4edfbc8e9e6fce0fae7f8e1eba6ebe7e5).
...
Learn prompt engineering best practices for extended thinking.](/docs/en/build-with-claude/prompt-engineering/extended-thinking-tips)
