...
**Source:** http://platform.claude.com/docs/en/api/beta/agents/update
...
model: optional [BetaManagedAgentsModel](/docs/en/api/beta#beta_managed_agents_model) or [BetaManagedAgentsModelConfigParams](/docs/en/api/beta#beta_managed_agents_model_config_params) { id, speed }
