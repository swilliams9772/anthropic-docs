...
| Language | Claude Opus 41 | Claude Sonnet 41 | Claude Sonnet 3.71 | Claude Sonnet 3.5 v2 ([deprecated](/en/docs/about-claude/model-deprecations)) | Claude Haiku 3.5 |
| --- | --- | --- | --- | --- | --- |
...
Find a wide range of pre-crafted prompts for various tasks and industries. Perfect for inspiration or quick starts.](/en/resources/prompt-library)
