...
For basic authentication, retrieve an Anthropic API key from the [Anthropic Console](https://console.anthropic.com/) and set the `ANTHROPIC_API_KEY` environment variable, as demonstrated in the [Quick start](/_sites/docs.anthropic.com/en/docs/claude-code/sdk?campaignId=13929719&source=i_email&medium=email&content=Oct2024AnalysisTool&messageTypeId=140367#quick-start).
...
# [​](#python-specific-best-practices) Python-Specific Best Practices
...
# [​](#ipython%2Fjupyter-tips) IPython/Jupyter Tips
