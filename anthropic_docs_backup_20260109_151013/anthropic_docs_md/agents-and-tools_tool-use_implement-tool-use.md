...
**Source:** https://docs.anthropic.com/en/docs/agents-and-tools/tool-use/implement-tool-use#forcing-tool-use
...
# [​](#handling-the-max-tokens-stop-reason) Handling the `max_tokens` stop reason
...
See the [general formatting requirements above](/_sites/docs.anthropic.com/en/docs/agents-and-tools/tool-use/implement-tool-use#handling-tool-use-and-tool-result-content-blocks) for other formatting rules.
