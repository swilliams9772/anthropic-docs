...
**Source:** https://docs.anthropic.com/en/resources/quickstarts
...
[Go to Customer Support Agent Quickstart](/anthropics/anthropic-quickstarts/blob/main/customer-support-agent)
...
[Go to Financial Data Analyst Quickstart](/anthropics/anthropic-quickstarts/blob/main/financial-data-analyst)
...
[Go to Computer Use Demo Quickstart](/anthropics/anthropic-quickstarts/blob/main/computer-use-demo)
...
This project is licensed under the MIT License - see the [LICENSE](/anthropics/anthropic-quickstarts/blob/main/LICENSE) file for details.
