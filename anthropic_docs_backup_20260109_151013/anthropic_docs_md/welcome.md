...
Set up your development environment for building with Claude.## Learn about Claude

Learn about the family of Claude models.[## Prompt Library

Explore example prompts for inspiration.](/en/resources/prompt-library/library)
...
Enjoy easier, more powerful prompting in your browser with the Workbench and prompt generator tool.](https://console.anthropic.com)[## Anthropic Cookbook
...
Summarize text, answer questions, extract data, translate text, and explain and generate code.[## Vision
