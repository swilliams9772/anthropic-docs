...
**Source:** https://docs.anthropic.com/en/docs/claude-code/setup#installation
...
Traditional method shown in the [install steps above](/_sites/docs.anthropic.com/en/docs/claude-code/setup?subjects=announcements#install-and-authenticate)
