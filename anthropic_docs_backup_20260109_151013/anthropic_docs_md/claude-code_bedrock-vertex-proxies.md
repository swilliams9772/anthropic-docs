...
**Source:** https://docs.anthropic.com/en/docs/claude-code/bedrock-vertex-proxies#model-configuration
...
Use Claude models through AWS infrastructure with IAM-based authentication and AWS-native monitoring[## Google Vertex AI
...
Configure Claude Code to work with your organization’s proxy servers and SSL/TLS requirements[## LLM Gateway
